...
**Satu klaim yang belum diverifikasi ulang dan harus dicek saat implementasi**: commit yang dibuat lewat GitHub API dengan installation token ditandatangani GitHub dan muncul sebagai `Verified`.
